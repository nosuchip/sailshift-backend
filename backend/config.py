...
EMAIL_CONTACT_US_ADDRESS = os.getenv('EMAIL_CONTACT_US_ADDRESS', EMAIL_FROM_ADDRESS)
...
DOCUMENT_DEFAULT_PRICE_USD = os.getenv('DOCUMENT_DEFAULT_PRICE_USD', 10)
...
print(f'config:EMAIL_CONTACT_US_ADDRESS = {EMAIL_CONTACT_US_ADDRESS}')
...
print(f'config:STRIPE_PUBLISHABLE_KEY = {STRIPE_PUBLISHABLE_KEY}')
...
print(f'config:DOCUMENT_DEFAULT_PRICE_USD = {DOCUMENT_DEFAULT_PRICE_USD}')
